const DashboardHome = ({ isLargeText }) => {
  return (
    <div className="p-8">
      ...
      <div
        className={`grid ${isLargeText ? "grid-cols-1" : "grid-cols-1 md:grid-cols-2 lg:grid-cols-3"} gap-8`}
      >
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 text-center balance-card">
